...
from .dist_class_sampler import DistributedSampler
...
class baseline_dataset():
    ...
    def get_loader(self):
        ...
        if self.distrubuted:
            ...
            train_sampler = DistributedSampler(self.train_set, len(self.train_set), shuffle=True, pair_num=self.args.pair_num)
            valid_sampler = DistributedSampler(self.val_set, len(self.val_set), shuffle=False, pair_num=self.args.pair_num)
